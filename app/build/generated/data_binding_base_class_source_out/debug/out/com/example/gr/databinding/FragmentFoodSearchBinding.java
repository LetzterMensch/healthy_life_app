...
public final class FragmentFoodSearchBinding implements ViewBinding {
  ...
  @NonNull
  public static FragmentFoodSearchBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFoodSearchBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_food_search, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFoodSearchBinding bind(@NonNull View rootView) {
