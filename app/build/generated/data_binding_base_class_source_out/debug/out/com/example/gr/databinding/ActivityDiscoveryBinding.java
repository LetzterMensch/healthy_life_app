...
public final class ActivityDiscoveryBinding implements ViewBinding {
  ...
  @NonNull
  public final ProgressBar discoveryBleProgressbar;
  ...
  private ActivityDiscoveryBinding(@NonNull LinearLayout rootView,
      @NonNull ProgressBar discoveryBleProgressbar, @NonNull ListView discoveryDeviceCandidatesList,
      @NonNull TextView discoveryHint, @NonNull TextView discoveryNote,
      @NonNull ProgressBar discoveryProgressbar, @NonNull Button discoveryStart) {
    this.rootView = rootView;
    this.discoveryBleProgressbar = discoveryBleProgressbar;
  ...
  public static ActivityDiscoveryBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.discovery_ble_progressbar;
      ProgressBar discoveryBleProgressbar = ViewBindings.findChildViewById(rootView, id);
      if (discoveryBleProgressbar == null) {
        break missingId;
      }
      ...
      return new ActivityDiscoveryBinding((LinearLayout) rootView, discoveryBleProgressbar,
          discoveryDeviceCandidatesList, discoveryHint, discoveryNote, discoveryProgressbar,
          discoveryStart);
    }
