...
import com.example.gr.model.database.dao.DiaryDAO_Impl;
import com.example.gr.model.database.dao.ExerciseDAO;
import com.example.gr.model.database.dao.ExerciseDAO_Impl;
import com.example.gr.model.database.dao.FoodDAO;
import com.example.gr.model.database.dao.FoodDAO_Impl;
import com.example.gr.model.database.dao.FoodLogDAO;
import com.example.gr.model.database.dao.FoodLogDAO_Impl;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `food` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `uuid` TEXT, `name` TEXT, `numberOfServings` REAL NOT NULL, `servingSize` REAL NOT NULL, `calories` INTEGER NOT NULL, `carb` REAL NOT NULL, `protein` REAL NOT NULL, `fat` REAL NOT NULL, `isCustomized` INTEGER NOT NULL, `subFoodIds` TEXT, `timestamp` INTEGER NOT NULL)");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `foodlog` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `totalCarb` REAL NOT NULL, `totalProtein` REAL NOT NULL, `totalFat` REAL NOT NULL, `totalCalories` INTEGER NOT NULL, `meal` INTEGER NOT NULL, `numberOfServings` REAL NOT NULL, `foodId` INTEGER NOT NULL, `foodUUID` TEXT, `diaryId` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `recipe` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `foodID` INTEGER NOT NULL, `foodUUID` TEXT, `name` TEXT, `image` TEXT, `description` TEXT, `carbs` REAL NOT NULL, `protein` REAL NOT NULL, `fat` REAL NOT NULL, `calories` INTEGER NOT NULL, `ingredients` TEXT, `url` TEXT, `timestamp` INTEGER NOT NULL)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '9d8ce381089865e602168a60dad716b6')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsFood.put("uuid", new TableInfo.Column("uuid", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashMap<String, TableInfo.Column> _columnsFoodlog = new HashMap<String, TableInfo.Column>(10);
        ...
        _columnsFoodlog.put("foodUUID", new TableInfo.Column("foodUUID", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashMap<String, TableInfo.Column> _columnsRecipe = new HashMap<String, TableInfo.Column>(13);
        ...
        _columnsRecipe.put("foodUUID", new TableInfo.Column("foodUUID", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsRecipe.put("timestamp", new TableInfo.Column("timestamp", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "9d8ce381089865e602168a60dad716b6", "92f6de289a869724de9fd8415678f84b");
