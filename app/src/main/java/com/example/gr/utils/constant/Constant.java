...
public interface Constant {
    ...
    String KEY_INTENT_ADD_FOOD_OBJECT = "add_new_food_object";
    String KEY_INTENT_DIARY_OBJECT = "diary_object";
    String KEY_INTENT_RECORDED_WORKOUT_OBJECT = "recorded_workout_object";
    String KEY_INTENT_DEVICE_OBJECT = "device_object";
