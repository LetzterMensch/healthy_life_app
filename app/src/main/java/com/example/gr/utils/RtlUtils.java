...
public class RtlUtils {
    ...
    {
        return ControllerApplication.getPrefs().getBoolean(GBPrefs.RTL_SUPPORT, false);
    }
    ...
    {
        return ControllerApplication.getPrefs().getBoolean(GBPrefs.RTL_CONTEXTUAL_ARABIC, false);
    }
    ...
    public static String fixRtl(String oldString) {
        ...
        int line_max_size = ControllerApplication.getPrefs().getInt("rtl_max_line_length", 18);
