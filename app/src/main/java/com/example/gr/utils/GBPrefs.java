...
public class GBPrefs {
    ...
    public static final String USER_NAME_DEFAULT = "gr-user";
    ...
    public boolean getAutoReconnect(GBDevice device) {
        SharedPreferences deviceSpecificPreferences = ControllerApplication.getDeviceSpecificSharedPrefs(device.getAddress());
...
//            GB.log("Error parsing date: " + date, GB.ERROR, ex);
    ...
    public String getTimeFormat() {
        ...
        if (DeviceSettingsPreferenceConst.PREF_TIMEFORMAT_AUTO.equals(timeFormat)) {
            if (DateFormat.is24HourFormat(ControllerApplication.getContext())) {
