...
//                getSupport().logMessageContent(value);
    ...
    private boolean sendFirmwareData(byte[] fwbytes) {
        ...
        try {
            ...
            if (ControllerApplication.getDeviceSpecificSharedPrefs(getDevice().getAddress()).getBoolean("low_latency_fw_update", true)) {
