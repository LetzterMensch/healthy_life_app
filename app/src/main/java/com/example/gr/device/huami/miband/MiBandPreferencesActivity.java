...
import static com.example.gr.constant.MiBandConst.PREF_MIBAND_ADDRESS;
...
import com.example.gr.device.settings.AbstractPreferenceFragment;
import com.example.gr.device.settings.AbstractSettingsActivityV2;
...
//            setPreferencesFromResource(R.xml.miband_preferences, rootKey);
        ...
        private void tryVibration(NotificationType type) {
            ...
            spec.type = type;
            ControllerApplication.deviceService().onNotification(spec);
        }
    }
}
