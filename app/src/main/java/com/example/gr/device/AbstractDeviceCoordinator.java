...
//import static nodomain.freeyourgadget.gadgetbridge.ControllerApplication.getPrefs;


import static com.example.gr.ControllerApplication.getPrefs;
...
import com.example.gr.data.sample.Spo2Sample;
...
import com.example.gr.database.entities.BatteryLevelDao;
...
public abstract class AbstractDeviceCoordinator implements DeviceCoordinator {
    ...
    public final void deleteDevice(final GBDevice gbDevice) throws GBException {
        ...
        if (gbDevice.isConnected() || gbDevice.isConnecting()) {
            ControllerApplication.deviceService(gbDevice).disconnect();
        }
        ...
        ControllerApplication.deleteDeviceSpecificSharedPrefs(gbDevice.getAddress());
