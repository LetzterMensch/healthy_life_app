...
public abstract class AbstractActivitySample implements com.example.gr.data.sample.ActivitySample {
    private com.example.gr.data.sample.SampleProvider mProvider;

    @Override
    public com.example.gr.data.sample.SampleProvider getProvider() {
        return mProvider;
    }
    ...
    public String toString() {
        int kind = getProvider() != null ? getKind() : com.example.gr.data.sample.ActivitySample.NOT_MEASURED;
