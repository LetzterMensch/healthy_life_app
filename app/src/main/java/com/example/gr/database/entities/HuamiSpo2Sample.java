...
public class HuamiSpo2Sample extends AbstractSpo2Sample {
    ...
    public HuamiSpo2Sample(long timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public HuamiSpo2Sample(long timestamp, long deviceId, long userId, int typeNum, int spo2) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getHuamiSpo2SampleDao() : null;
    }
