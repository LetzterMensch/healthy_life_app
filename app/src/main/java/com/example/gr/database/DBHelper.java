...
import com.example.gr.database.entities.ActivityDescription;
import com.example.gr.database.entities.ActivityDescriptionDao;
import com.example.gr.database.entities.Alarm;
import com.example.gr.database.entities.AlarmDao;
import com.example.gr.database.entities.Contact;
import com.example.gr.database.entities.ContactDao;
...
import com.example.gr.database.entities.DeviceDao;
import com.example.gr.database.entities.Reminder;
import com.example.gr.database.entities.ReminderDao;
import com.example.gr.database.entities.Tag;
import com.example.gr.database.entities.TagDao;
import com.example.gr.database.entities.User;
import com.example.gr.database.entities.UserAttributes;
import com.example.gr.database.entities.UserDao;
import com.example.gr.database.entities.WorldClock;
import com.example.gr.database.entities.WorldClockDao;
import com.example.gr.device.DeviceCoordinator;
import com.example.gr.device.GBDevice;
import com.example.gr.device.model.ValidByDate;
