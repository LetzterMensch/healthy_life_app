 ...
 */
public class WorldClock implements com.example.gr.controller.device.model.WorldClock {
    ...
    public WorldClock(long deviceId, long userId, String worldClockId, String label, Boolean enabled, String code, String timeZoneId) {
