...
import com.example.gr.model.database.entities.ActivityDescription;
import com.example.gr.model.database.entities.ActivityDescriptionDao;
import com.example.gr.model.database.entities.Alarm;
import com.example.gr.model.database.entities.AlarmDao;
import com.example.gr.model.database.entities.Contact;
import com.example.gr.model.database.entities.ContactDao;
...
import com.example.gr.model.database.entities.DeviceAttributesDao;
import com.example.gr.model.database.entities.DeviceDao;
import com.example.gr.model.database.entities.Reminder;
import com.example.gr.model.database.entities.ReminderDao;
import com.example.gr.model.database.entities.Tag;
import com.example.gr.model.database.entities.TagDao;
import com.example.gr.model.database.entities.User;
import com.example.gr.model.database.entities.UserAttributes;
import com.example.gr.model.database.entities.UserDao;
import com.example.gr.model.database.entities.WorldClock;
import com.example.gr.model.database.entities.WorldClockDao;
import com.example.gr.controller.device.DeviceCoordinator;
import com.example.gr.controller.device.GBDevice;
import com.example.gr.controller.device.model.ValidByDate;
...
//        deviceAttributes.add(attributes);
     ...
     * . Calendar events that may also be modeled as alarms are not stored
