 ...
 */
public class BaseActivitySummary implements com.example.gr.model.ActivitySummary {
    ...
    public BaseActivitySummary(Long id, String name, java.util.Date startTime, java.util.Date endTime, int activityKind, Integer baseLongitude, Integer baseLatitude, Integer baseAltitude, String gpxTrack, String rawDetailsPath, long deviceId, long userId, String summaryData, byte[] rawSummaryData) {
        this.id = id;
        this.name = name;
        ...
        this.rawDetailsPath = rawDetailsPath;
    ...
    public String getRawDetailsPath() {
        return rawDetailsPath;
    }

    public void setRawDetailsPath(String rawDetailsPath) {
        this.rawDetailsPath = rawDetailsPath;
    }
