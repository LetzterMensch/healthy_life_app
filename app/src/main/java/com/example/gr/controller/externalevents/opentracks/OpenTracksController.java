...
package com.example.gr.controller.externalevents.opentracks;
...
public class OpenTracksController extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ControllerApplication gbApp = ControllerApplication.getApp();
    ...
    public static void stopRecording(Context context) {
        ...
        OpenTracksContentObserver openTracksObserver = ControllerApplication.getApp().getOpenTracksObserver();
        if (openTracksObserver != null) {
            openTracksObserver.finish();
        }
        ControllerApplication.getApp().setOpenTracksObserver(null);
    }
