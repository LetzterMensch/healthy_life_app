...
import com.example.gr.controller.activity.charts.ActivityAnalysis;
...
public class DailyTotals {
    ...
    public long[] getDailyTotalsForAllDevices(Calendar day) {
        ...
        if (context instanceof ControllerApplication) {
            ControllerApplication gbApp = (ControllerApplication) context;
