...
package com.example.gr.controller.device.huami.operations.update;
...
import com.example.gr.controller.service.btle.actions.SetDeviceBusyAction;
import com.example.gr.controller.service.btle.actions.SetProgressAction;
import com.example.gr.controller.device.huami.AbstractHuamiFirmwareInfo;
import com.example.gr.controller.device.huami.AbstractHuamiOperation;
import com.example.gr.controller.device.huami.HuamiFirmwareType;
...
public class UpdateFirmwareOperation extends AbstractHuamiOperation {
    ...
    protected final Prefs prefs = ControllerApplication.getPrefs();
