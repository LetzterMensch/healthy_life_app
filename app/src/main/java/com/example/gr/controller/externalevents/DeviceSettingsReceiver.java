...
public class DeviceSettingsReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        final GBDevice targetDevice = ControllerApplication.getApp()
                .getDeviceManager()
        ...
        final SharedPreferences prefs = ControllerApplication.getDeviceSpecificSharedPrefs(targetDevice.getAddress());
        ...
        ControllerApplication.deviceService().onSendConfiguration(key);
    }
}
