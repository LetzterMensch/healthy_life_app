...
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_AGPS_EXPIRE_TIME;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_AGPS_EXPIRY_REMINDER_ENABLED;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_AGPS_EXPIRY_REMINDER_TIME;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_AGPS_UPDATE_TIME;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_ALERT_TONE;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_ALWAYS_ON_DISPLAY_END;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_ALWAYS_ON_DISPLAY_FOLLOW_WATCHFACE;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_ALWAYS_ON_DISPLAY_MODE;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_ALWAYS_ON_DISPLAY_START;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_ALWAYS_ON_DISPLAY_STYLE;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_BT_CONNECTED_ADVERTISEMENT;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_CAMERA_REMOTE;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_COVER_TO_MUTE;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_CROWN_VIBRATION;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_DATEFORMAT;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_DISPLAY_CALLER;
...
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_GPS_BAND;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_GPS_COMBINATION;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_GPS_MODE_PRESET;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_GPS_SATELLITE_SEARCH;
...
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_HEARTRATE_MEASUREMENT_INTERVAL;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_HEARTRATE_SLEEP_BREATHING_QUALITY_MONITORING;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_HEARTRATE_STRESS_MONITORING;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_HEARTRATE_STRESS_RELAXATION_REMINDER;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_HEARTRATE_USE_FOR_SLEEP_DETECTION;
...
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_LANGUAGE_AUTO;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_LOWER_BUTTON_SHORT_PRESS;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_MEASUREMENT_SYSTEM;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_NOTIFICATION_DELAY_CALLS;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_OFFLINE_VOICE_LANGUAGE;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_OFFLINE_VOICE_RESPOND_SCREEN_ON;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_OFFLINE_VOICE_RESPOND_TURN_WRIST;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_OFFLINE_VOICE_RESPONSE_DURING_SCREEN_LIGHTING;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_SCREEN_AUTO_BRIGHTNESS;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_SCREEN_BRIGHTNESS;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_SCREEN_ON_ON_NOTIFICATIONS;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_SCREEN_TIMEOUT;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_SLEEP_MODE_SLEEP_SCREEN;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_SLEEP_MODE_SMART_ENABLE;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_SPO2_ALL_DAY_MONITORING;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_SPO2_LOW_ALERT_THRESHOLD;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_TEXT_TO_SPEECH;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_TIMEFORMAT;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_TIMEFORMAT_AUTO;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_UPPER_BUTTON_LONG_PRESS;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_USER_FITNESS_GOAL;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_USER_FITNESS_GOAL_NOTIFICATION;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_VIBRATE_FOR_ALERT;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_VOLUME;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_WEARDIRECTION;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_WORKOUT_DETECTION_ALERT;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_WORKOUT_DETECTION_CATEGORIES;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_WORKOUT_DETECTION_SENSITIVITY;
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_WORKOUT_KEEP_SCREEN_ON;
import static com.example.gr.utils.constant.HuamiConst.PREF_EXPOSE_HR_THIRDPARTY;
import static com.example.gr.utils.constant.MiBandConst.PREF_NIGHT_MODE;
import static com.example.gr.utils.constant.MiBandConst.PREF_NIGHT_MODE_END;
import static com.example.gr.utils.constant.MiBandConst.PREF_NIGHT_MODE_START;
...
import com.example.gr.controller.device.capability.GpsCapability;
import com.example.gr.controller.device.capability.WorkoutDetectionCapability;
...
import com.example.gr.controller.device.huami.ActivateDisplayOnLift;
import com.example.gr.controller.device.huami.ActivateDisplayOnLiftSensitivity;
import com.example.gr.controller.device.huami.AlwaysOnDisplay;
import com.example.gr.controller.device.huami.HuamiLanguageType;
...
import com.example.gr.controller.device.huami.zeppos.ZeppOsMenuType;
...
public class ZeppOsConfigService extends AbstractZeppOsService {
    ...
    private void handle2021ConfigResponse(final byte[] payload) {
        ...
        final Map<String, Object> prefs = new ConfigParser(configGroup, includesConstraints)
    ...
    public void requestConfig(final TransactionBuilder builder, final ConfigGroup config) {
        requestConfig(builder, config, true, ConfigArg.getAllArgsForConfigGroup(config));
    }
...
//        PASSWORD_TEXT(ConfigGroup.LOCKSCREEN, ConfigType.STRING, 0x02, PREF_PASSWORD),
        ...
        public static ConfigArg fromCode(final ConfigGroup configGroup, final byte code) {
            for (final ConfigArg arg : values()) {
        ...
        public static List<ConfigArg> getAllArgsForConfigGroup(final ConfigGroup configGroup) {
            final List<ConfigArg> configArgs = new ArrayList<>();
            for (final ConfigArg arg : values()) {
    ...
    public static boolean deviceHasConfig(final Prefs devicePrefs, final ConfigArg config) {
    ...
    public class ConfigParser {
        ...
        public Map<String, Object> parse(final int expectedNumConfigs, final byte[] bytes) {
            ...
            while (buf.position() < buf.limit()) {
                ...
                final ConfigArg configArg = ConfigArg.fromCode(configGroup, configArgByte);
                if (configArg == null) {
