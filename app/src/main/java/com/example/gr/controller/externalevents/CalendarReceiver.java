...
import com.example.gr.model.database.entities.CalendarSyncState;
import com.example.gr.model.database.entities.CalendarSyncStateDao;
...
public class CalendarReceiver extends BroadcastReceiver {
    ...
    public CalendarReceiver(GBDevice gbDevice) {
        ...
        mGBDevice = gbDevice;
        onReceive(ControllerApplication.getContext(), new Intent());
    }
        ...
        while (ids.hasMoreElements()) {
            ...
            if (syncState == EventState.NOT_SYNCED || syncState == EventState.NEEDS_UPDATE) {
                ...
                if (syncState == EventState.NEEDS_UPDATE) {
                    ControllerApplication.deviceService(mGBDevice).onDeleteCalendarEvent(CalendarEventSpec.TYPE_UNKNOWN, i);
                }
                ControllerApplication.deviceService(mGBDevice).onAddCalendarEvent(calendarEventSpec);
    ...
    public static void forceSync() {
        ...
        ControllerApplication.getContext().sendBroadcast(intent);
    }
}
