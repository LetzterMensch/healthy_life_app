...
import static com.example.gr.utils.constant.DeviceSettingsPreferenceConst.PREF_VOICE_SERVICE_LANGUAGE;
...
public class ZeppOsAlexaService extends AbstractZeppOsService {
    ...
    public boolean onSendConfiguration(final String config, final Prefs prefs) {
        switch (config) {
            case PREF_VOICE_SERVICE_LANGUAGE:
                final String alexaLanguage = prefs.getString(PREF_VOICE_SERVICE_LANGUAGE, null);
