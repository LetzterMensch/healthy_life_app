...
public class TimeChangeReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_DST_CHANGED_OR_PERIODIC_SYNC = "com.example.gr.DST_CHANGED_OR_PERIODIC_SYNC";
    ...
    public static void ifEnabledScheduleNextDstChangeOrPeriodicSync(final Context context) {
        if (ControllerApplication.getPrefs().getBoolean("datetime_synconconnect", true)) {
            scheduleNextDstChangeOrPeriodicSync(context);
        }
    }
