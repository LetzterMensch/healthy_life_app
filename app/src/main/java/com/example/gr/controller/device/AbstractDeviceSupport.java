...
import com.example.gr.controller.device.events.GBDeviceEventDisplayMessage;
...
import com.example.gr.controller.device.events.GBDeviceEventUpdateDeviceInfo;
import com.example.gr.controller.device.events.GBDeviceEventUpdateDeviceState;
...
//    }
    ...
    protected void handleGBDeviceEvent(GBDeviceEventUpdatePreferences savePreferencesEvent) {
        ...
        savePreferencesEvent.update(ControllerApplication.getDeviceSpecificSharedPrefs(getDevice().getAddress()));
        gbDevice.sendDeviceUpdateIntent(context);
    }
...
*/
     ...
     *
     * @param reminders {@link ArrayList} containing {@link com.example.gr.model.database.entities.Reminder} instances
     */
    @Override
     ...
     * overridden and implemented by the device support class.
     * @param cards {@link ArrayList} containing {@link } instances
     */
//    @Override
