...
import com.example.gr.controller.device.huami.miband.MiBandPairingActivity;
...
import com.example.gr.controller.device.AbstractBLEDeviceCoordinator;
...
public abstract class HuamiCoordinator extends AbstractBLEDeviceCoordinator {
    ...
    protected static Prefs getPrefs(final GBDevice device) {
        return new Prefs(ControllerApplication.getDeviceSpecificSharedPrefs(device.getAddress()));
    }

    public static DateTimeDisplay getDateDisplay(Context context, String deviceAddress) throws IllegalArgumentException {
        SharedPreferences sharedPrefs = ControllerApplication.getDeviceSpecificSharedPrefs(deviceAddress);
    ...
    public static AlwaysOnDisplay getAlwaysOnDisplay(final String deviceAddress) {
        final SharedPreferences prefs = ControllerApplication.getDeviceSpecificSharedPrefs(deviceAddress);
    ...
    public static ActivateDisplayOnLift getActivateDisplayOnLiftWrist(Context context, String deviceAddress) {
        SharedPreferences prefs = ControllerApplication.getDeviceSpecificSharedPrefs(deviceAddress);
...
*/
    ...
    protected static Date getTimePreference(String key, String defaultValue, String deviceAddress) {
        ...
        if (deviceAddress == null) {
            prefs = ControllerApplication.getPrefs();
        } else {
            prefs = new Prefs(ControllerApplication.getDeviceSpecificSharedPrefs(deviceAddress));
        }
