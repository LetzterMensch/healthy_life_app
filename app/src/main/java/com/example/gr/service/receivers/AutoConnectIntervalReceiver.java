...
package com.example.gr.service.receivers;
...
public class AutoConnectIntervalReceiver extends BroadcastReceiver {
    ...
    public void scheduleReconnect(int delay) {
        ...
        AlarmManager am = (AlarmManager) (ControllerApplication.getContext().getSystemService(Context.ALARM_SERVICE));
        Intent intent = new Intent("GB_RECONNECT");
        intent.setPackage(BuildConfig.APPLICATION_ID);
        PendingIntent pendingIntent = PendingIntentUtils.getBroadcast(ControllerApplication.getContext(), 0, intent, 0, false);
